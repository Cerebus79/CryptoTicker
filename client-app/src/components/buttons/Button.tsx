interface props {
    content: string;
    loadingText: string;
    type?: React.ButtonHTMLAttributes<HTMLButtonElement>["type"];//"submit" | "reset" | "button" | undefined; //React.ButtonHTMLAttributes<HTMLButtonElement>["type"]
    loading:boolean;
}
...
export default function Button({ content = "Button", type = "submit", loading=false }: props) {
    ...
    return (
        ...
        {loading ? (
                        <button disabled type="button" className={styling}>
